...
uint64_t world = READ64(READ64(g_base_addr + 0x417aa80));
uint64_t level = tsl_decrypt_prop(&tsl, world + 0xa0);
...
uint64_t actor = tsl_decrypt_actor(&tsl, level + 0x290);
...
uint64_t gnames = READ64(g_base_addr + 0x41eb808);
